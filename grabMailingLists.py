...
def main():
    ...
    r = requests.get('https://department-lists.uci.edu/mailman/roster/'+emailList+'?language=en&roster-email='+email+'&roster-pw='+pwd+'&SubscriberRoster=Visit+Subscriber+List')
    data = r.text
    data = data.split('\n')
